...
export default function uniaoXIGuerreiros() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <h1 className="text-3xl font-bold text-custom-blue mt-5">
        ...
        <p className="text-custom-blue mt-5">
          No último jogo pela Liga Ouro, o time adversário não apareceu e o União venceu os 2 jogos por W.O
        </p> <br></br>

        <p className="text-custom-blue">
          O time aproveitou para começar a comemorar o seu aniversário de 11 anos mais cedo.
        </p>

        <div className="flex justify-left mt-10">
          <Image src="/festa11anosUniao.jpeg" alt="Imagem" width={500} height={500} />
        </div>
        <p className="text-custom-blue"> img da comemoração </p>
      </section>
