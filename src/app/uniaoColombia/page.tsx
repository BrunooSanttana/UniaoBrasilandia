    ...
    <div className="flex flex-col min-h-screen">
      ...
      <h1 className="text-3xl font-bold text-custom-blue mt-5">
        ...
        <p className="text-custom-blue mt-5">
          No último jogo pela Liga Ouro, o União enfrentou a equipe Colombia em uma partida emocionante e garantiu as 2 vitórias.<br></br>
          No primeiro jogo, a equipe do União venceu por 3x2. Já no seguno jogo aproveitou o pouco elenco do time adversário e conseguiu uma vitória larga por 3x0.
        </p>
