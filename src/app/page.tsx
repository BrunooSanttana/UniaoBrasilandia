  ...
  return (
    <div>
      ...
      <header className="w-full bg-custom-blue py-4 px-24 flex items-center justify-between">
        ...
        <nav>
          <a href="#elenco" className="text-white mr-5 icon-link">Elenco</a>
          <a href="#diretoria" className="text-white  mr-5 icon-link">Diretoria</a>
          <a href="#galeria" className="text-white  mr-5 icon-link">Galeria</a>
          <a href="#news" className="text-white  mr-5 icon-link">Infos</a>
          <a href="#patrocinio" className="text-white  mr-5 icon-link">Patrocinadores</a>
          <a href="/noticias" className="text-white  mr-5  icon-link">Noticias</a>
          <a href="#contato" className="text-white  mr-5 icon-link">Contato</a>
        </nav>
      </header >
      <div>
      ...
      <main className="w-full items-center justify-between p-30"> <br></br><br></br>
        ...
        < div className="max-w-full mx-auto mb-8 flex flex-col md:flex-row" > {/* Adicionado flex-col e md:flex-row */}
          ...
          <Image src="/newLogo.png" alt="Logo União" className="hidden md:block max-w-md mx-auto mb-4" width={500} height={200} />
