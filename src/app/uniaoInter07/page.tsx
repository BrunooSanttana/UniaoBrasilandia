...
export default function uniaoInter07() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="p-5 flex-grow">
        <h1 className="text-3xl font-bold text-custom-blue mt-5">União x Inter 07</h1> 
        <p className= "text-xs text-custom-blue" > 06/04/2024 - Assessoria de imprensa</p>


        <p className="text-custom-blue mt-5">
          No último jogo pela Liga Ouro, o União recebeu a equipe Inter 07, Os dois jogos foram disputados com grande intensidade, resultando em uma vitória para cada lado.<br></br>
          No primeiro jogo, o Inter saiu vitorioso por 3x2.  Já no segundo jogo, o União conseguiu a vitória por 4x3.
        </p> <br></br>

        <p className="text-custom-blue">
          Bruno Santana, o famoso <strong>Jesus</strong> fez seu primeiro gol pela equipe, e sua comemoração de apoio ao anti-racismo foi eleito o momento mais íconico. 
        </p>
